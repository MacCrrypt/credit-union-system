...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] min-h-screen flex flex-col">
    <header class="w-full px-6 py-4 lg:px-8 lg:pt-6">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4 max-w-7xl mx-auto">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="inline-flex items-center px-5 py-2 text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-full hover:border-[#1915014a] dark:hover:border-[#62605b] transition">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center px-5 py-2 text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC] border border-transparent rounded-full bg-white dark:bg-[#161615] shadow-[0px_10px_30px_rgba(0,0,0,0.06)] hover:bg-[#f8f8f6] dark:hover:bg-[#1f1f1d] transition">
                        Sign in
                    </a>
                @endauth
            </nav>
    ...
    <footer class="w-full border-t border-[#e3e3e0] dark:border-[#3E3E3A] py-6">
        <div
            class="mx-auto flex max-w-7xl flex-col gap-4 px-6 text-sm text-[#706f6c] dark:text-[#A1A09A] sm:flex-row sm:items-center sm:justify-between lg:px-8">
            <p>&copy; {{ date('Y') }} {{ config('app.name', 'SignatureSuite') }}. All rights reserved.</p>
            <p>Built to simplify member management for credit unions.</p>
        </div>
    </footer>
</body>
